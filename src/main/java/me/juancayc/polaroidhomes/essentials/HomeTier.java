...
/**
 * One entry of the EssentialsX {@code sethome-multiple} section: a group name and the home limit it
 * grants.
 *
 * <p>Bukkit-free on purpose, so the ordering and the locked-slot attribution can be unit tested.
 * The menu needs to answer "which rank unlocks slot 7?", and getting that wrong means telling a
 * paying player they already have a perk they do not.
 */
